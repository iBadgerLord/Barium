...
public class GrandWaterBottle extends PotionBase {

    public GrandWaterBottle(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (playerEntity == null || !playerEntity.abilities.creativeMode) {
            if (stack.isEmpty()) {
                return new ItemStack(ItemRegistry.emptyGrandPotion);
            }

            if (playerEntity != null) {
                playerEntity.inventory.insertStack(new ItemStack(ItemRegistry.emptyGrandPotion));
            }
        }
